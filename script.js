const wordPairs = [
    ...
    ["uniwersytet publiczny", "state school (AmE)"],
    ["przystąpić do testu", "take a test"],
    ["weterynaria", "veterinary science"],
    ["rozmawiać z kimś i jego ojczystym językiem", "do a conversation exchange"],
    ...
    ["uczący się we wspólnej grupie", "set up a study group"],
    ["borykać się", "struggle"],
    ["notować", "take/make notes"],
