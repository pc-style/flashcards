const wordPairs = [
    ["zdobyć stopień", "do a degree"],
    ["mieć dobre wyniki", "do well"],
    ["odrobić pracę domową", "do your homework"],
    ["ekonomia", "economics"],
    ["inżynieria", "engineering"],
    ["oblać egzamin", "fail an exam"],
    ["ukończyć szkołę", "graduate from school (AmE)"],
    ["prawo", "law"],
    ...
    ["szkoła publiczna (BrE)", "public school (BrE)"],
    ["szkoła prywatna", "private school"],
    ["uniwersytet publiczny", "public university"],
    ["ponownie przystąpić do egzaminu", "retake an exam (AmE)"],
    ["powtarzać materiał do testu", "revise for a test (BrE)"],
    ["szkoła średnia", "high school (AmE)"],
    ["szkoła publiczna", "state school (BrE) / public school (AmE)"],
    ["przystąpić do testu", "take a test"],
    ["prymus", "top student"],
